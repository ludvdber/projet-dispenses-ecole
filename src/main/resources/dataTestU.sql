...
-- === COURS EXTERNES ===
INSERT INTO TCORR_COURS(ID, FK_CORRESPONDANCE, CODE_COURS, INTITULE, ECTS, URL_FICHE_OFFIC) VALUES (1, 1, 'BINV1010-1', 'Algorithmique et programmation', 6, NULL);
INSERT INTO TCORR_COURS(ID, FK_CORRESPONDANCE, CODE_COURS, INTITULE, ECTS, URL_FICHE_OFFIC) VALUES (2, 1, 'BINV2090-2', 'Projet d''intégration', 8, NULL);
...
-- === MAPPING COURS EXTERNES → UEs ISFCE (per-cours) ===
INSERT INTO TCORR_COURS_UE(FK_CORR_COURS, FK_UE) VALUES (1, 'IPAP');  -- BINV1010-1 → IPAP
INSERT INTO TCORR_COURS_UE(FK_CORR_COURS, FK_UE) VALUES (2, 'IPID');  -- BINV2090-2 → IPID
INSERT INTO TCORR_COURS_UE(FK_CORR_COURS, FK_UE) VALUES (3, 'IPAP');  -- INFO-F101 → IPAP
...
(1, 3, 'LDV', NULL, 'BINV1010-1', 'Algorithmique et programmation', 6, 1, NULL, 'AUTO_RECONNU');
INSERT INTO TCOURS_ETUDIANT(ID, FK_DOSSIER, FK_ECOLE, ECOLE_SAISIE, CODE_COURS, INTITULE, ECTS, FK_CORR_COURS, URL_FICHE, STATUT_SAISIE) VALUES
